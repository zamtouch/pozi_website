                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                  ...
                  {(property as any).residential && (
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <div className="text-sm text-gray-600">Residential Area</div>
                        <div className="font-medium text-gray-900">
                          {typeof (property as any).residential === 'object' ? (property as any).residential.residential_name : 'N/A'}
                        </div>
                      </div>
                    </div>
                  )}
                  {closestUniversity && (
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <div className="font-medium text-gray-900">{closestUniversity.university.name}</div>
                      </div>
                    </div>
                  )}
                </div>
